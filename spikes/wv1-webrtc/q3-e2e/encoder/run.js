// Q3 encoder orchestrator (Node). Launches managed Chrome 151 over the CDP
...
// per wv1-spike-results.md Q2), opens the /metronome capture target tab,
// opens the extension's encoder.html page, and invokes startEncoding()
// there to establish the WebRTC ingest connection to wv1spike3's /ingest.
//
...
async function main() {
  ...
  await cdp.newPage(METRONOME_URL);
  await sleep(1000);
