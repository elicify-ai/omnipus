    ...
    >
      ...
      >
        ...
        >
          {sanitizedSvg ? (
            <div
              className="max-w-[90vw] max-h-[80vh] rounded-lg overflow-hidden shadow-2xl ring-1 ring-[var(--color-border)] bg-[var(--color-surface-2)] p-[var(--space-3)]"
      ...
      {scale !== 1 && (
        <div
          className="absolute bottom-10 right-4 text-[length:var(--type-caption-size)] text-[var(--color-muted)] bg-[var(--color-surface-2)]/80 px-[var(--space-2)] py-[var(--space-0-5)] rounded-full pointer-events-none"
          onClick={(e) => e.stopPropagation()}
        >
