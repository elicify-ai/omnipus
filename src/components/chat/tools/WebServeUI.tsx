...
function MalformedResultBlock({ raw }: { raw: unknown }) {
  ...
  return (
    ...
    <div data-testid="webserve-malformed-block" className="mt-[var(--space-2)] border-l-2 border-[var(--color-error)]/40 pl-[var(--space-2)] py-[var(--space-1)] text-[length:var(--type-utility-xs-size)] space-y-[var(--space-1)]">
      ...
      <details className="mt-[var(--space-1)]">
        ...
        <pre className="mt-[var(--space-1)] text-[var(--color-muted)] font-mono text-[length:var(--type-caption-size)] overflow-auto max-h-40 whitespace-pre-wrap break-all">
          {rawJson}
        </pre>
      </details>
    </div>
...
export function WebServeBlock({
  ...
  return (
    <div className="mt-[var(--space-2)] text-[length:var(--type-utility-xs-size)]">
      <PreviewToolHeader
