                    ...
                    >
                      ...
                      <span className="relative inline-block">
                        <select
                          ...
                          className="appearance-none bg-transparent text-[var(--color-muted)] hover:text-[var(--color-secondary)] pl-1 pr-3 py-0 text-[9px] focus-visible:outline-none focus-visible:border-[var(--color-accent)] rounded cursor-pointer"
                        >
