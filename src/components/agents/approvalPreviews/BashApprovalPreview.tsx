...
export function BashApprovalPreview({ args }: ToolApprovalPreviewContext) {
  ...
  return (
    <div>
      <p className="text-[length:var(--type-utility-xs-size)] text-[var(--color-muted)] mb-1">Command</p>
      <pre className="font-mono text-[length:var(--type-utility-xs-size)] bg-[var(--color-surface-2)] rounded-lg px-3 py-2 whitespace-pre-wrap break-all text-[var(--color-secondary)]">
        {preview.envPrefix && (
