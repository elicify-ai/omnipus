...
const badgeVariants = cva(
  'inline-flex items-center gap-1 rounded-full border px-2 py-0.5 text-[length:var(--type-utility-xs-size)] font-medium transition-colors motion-reduce:transition-none',
  {
    variants: {
      variant: {
        default:
