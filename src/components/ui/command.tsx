...
>(({ className, ...props }, ref) => (
  <div className="flex items-center border-b px-[var(--space-2-5)]" style={{ borderColor: 'var(--color-border)' }}>
    <CommandPrimitive.Input
      ref={ref}
      className={clsx("flex h-10 w-full rounded-md bg-transparent py-[var(--space-2-5)] text-[length:var(--type-body-compact-size)] outline-none [@media(pointer:coarse)]:min-h-[44px] disabled:cursor-not-allowed disabled:opacity-50", className)}
...
>((props, ref) => (
  <CommandPrimitive.Empty ref={ref} className="py-[var(--space-4)] text-center text-[length:var(--type-body-compact-size)]" style={{ color: 'var(--color-muted)' }} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Group
    ref={ref}
    className={clsx("overflow-hidden p-[var(--space-1)]", className)}
    style={{ color: 'var(--color-secondary)' }}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Separator
    ref={ref}
    className={clsx("-mx-[var(--space-1)] h-px", className)}
