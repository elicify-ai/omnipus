...
export function CriteriaBreakdown({ criteria, emptyText }: CriteriaBreakdownProps) {
  if (criteria.length === 0) {
    ...
    return <p className="text-[length:var(--type-utility-xs-size)] text-[var(--color-muted)]">{emptyText}</p>
  }
          ...
          >
            ...
            {c.provenance === 'inferred' && (
              <p
                ...
                className="text-[length:var(--type-caption-size)] italic text-[var(--color-accent)]"
              >
