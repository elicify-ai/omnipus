...
describe('resolveOmniboxInput (ADR-040 D5)', () => {
  ...
  it('preserves international text and reserved characters in the query', () => {
    expect(resolveOmniboxInput('@é 日本 🙂')).toBe(
      'https://www.google.com/search?q=%40%C3%A9%20%E6%97%A5%E6%9C%AC%20%F0%9F%99%82',
    )
  })

  it('preserves interior whitespace while trimming surrounding whitespace', () => {
    expect(resolveOmniboxInput('  cheap   flights  ')).toBe('https://www.google.com/search?q=cheap%20%20%20flights')
  })
