 ...
 *   the text, matching the native start-page search form in
 *   pkg/gateway/browser_start_page.go. Only OUTER whitespace is trimmed;
 *   interior whitespace between words is preserved exactly
