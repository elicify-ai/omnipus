...
2. **Read the relevant spec(s)** — determine which BRD/spec sections apply to your task:
   - `docs/internal/_archive/BRD/Omnipus BRD.md` §5.1–5.7.1 — all SEC-xx requirements and known limitations (LIM-01 through LIM-03)
   - `docs/internal/_archive/BRD/Omnipus Windows BRD appendic.md` — Windows sandbox backend (Job Objects, Restricted Tokens, DACL) for platform abstraction
   - `docs/internal/_archive/BRD/Omnipus_BRD_AppendixE_DataModel.md` — data model schemas for audit log format, config security section
...
- **Never invent SEC-xx IDs.** Read the BRD. If you reference a requirement, verify it exists in `docs/internal/_archive/BRD/Omnipus BRD.md` §5.1–5.7.1.
