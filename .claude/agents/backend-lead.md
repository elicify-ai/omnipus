...
1. **Read BRD/specs** — Read the relevant sections from:
   ...
   - `docs/internal/_archive/BRD/Omnipus_BRD_AppendixD_System_Agent.md` — agent types, system tools
   - `docs/internal/_archive/BRD/Omnipus_BRD_AppendixE_DataModel.md` — data model, file formats
