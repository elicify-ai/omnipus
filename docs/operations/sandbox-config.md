...
An older release had a `default_profile` field as a global fallback for an agent sandbox profile. Both fields were removed. New agents do not have a configurable sandbox profile.
