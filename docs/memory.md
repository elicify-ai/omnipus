...
This document describes the memory system as it ships today on `feature/iframe-preview-tier13`. The v0.3 "Rooms" redesign (`docs/design/memory-redesign-2026-05.md`) replaces most of this with a four-tier model and a graph index. That work is tracked in [#156](https://github.com/dapicom-ai/omnipus/issues/156) and is **not** described here as current behaviour.
