...
Amsterdam still runs verified runtime `ef76f7536`. Six clean alternating remote comparisons passed. Its separate unchanged controlled Linux gate passed 100 clicks/300 exact events at p95 182.6 ms against 200 ms, with dedicated-route and same-peer proof. Those results do not prove the follow-up source is deployed, long-duration acceptance, or remote-network latency below 200 ms.

[Current runtime evidence](browser-input-candidate-2026-09-13.md).
