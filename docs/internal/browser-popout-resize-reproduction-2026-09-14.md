...
Amsterdam now runs source `3f978959c19ead2466b9d82e7d5d126e1e74b64b`, binary SHA256 `106fd42b7da31896701c7192b1572b413d48f1483ba1a084906c035216321d79`, image digest `sha256:813b6574ca1cf9ecfeb89129fde506c9eeda66eeecacda4483afd29dcc183874`. Installed and running binaries match; machine configuration, region and resources are unchanged.

The exact Google search→visible YouTube result click passed on this build. New target `CD0758D7EA0C64A566E1EC89718AC723` recovered at17:13:12.133UTC with1426×718 measured CSS geometry, matching the unchanged full-screen viewer. Screenshot17:13:14.904 and raw decoded1344×672 video visibly fill the viewer; no large inset remains. This assertion and visual inspection occurred before any manual resize. The old first bounds pass still logged1426×575 at17:13:11; the verified content correction recovered it.

Subsequent client sizes1200×800,1700×1000 and1440×810 produced matching CSS viewports1186×708,1686×908 and1426×718, respectively. All sampled states had ready input and no alerts. After these resizes, a real click into YouTube’s search field followed by typing displayed exactly `omnipus test` at17:13:58.906UTC; no search submission was made. The test exited successfully, with zero page errors, and closed its owned browser. The bounded server-log window contained no convergence failure, input-dispatch failure or deadline error; normal Chrome/media warnings remain. This is a focused reproduction and resize/input check, not long-session endurance certification.

The actual contents command was also deliberately omitted in a local fault variant: the command-level assertion failed, and restored-source tests passed. Evidence and trace: `/Users/danielpiatkowski/AI-Agent-Workspace/omnipus/repo/.local/browser-input-final-validation/popout-google-youtube-candidate`. Failed candidate evidence is retained separately.
