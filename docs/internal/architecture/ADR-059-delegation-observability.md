...
- **Date:** 2026-08-10
- **⚠️ SUBSUMED IN PART 2026-08-11 by [ADR-060](ADR-060-structured-tool-failure-family.md):** W5 admitted `file_exists` to the structured tool-failure family as a one-off; ADR-060 states the general membership rule it was the first instance of, and supplies the Constraint #8 contract-impact section review finding C-04 demanded. D1–D5 are untouched.
