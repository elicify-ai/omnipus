...
> value `judge_refused_god_mode` (C-39, F1) has been **removed from `GoalStatusFrame.state`**
> entirely, in both copies, along with its SPA render branches and generated clients.
