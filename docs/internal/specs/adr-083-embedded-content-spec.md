...
| 82 | `src/components/library/preview/knowledgeMarkdown.embeds.test.tsx::audio-video-mermaid-pdf-page` | Integration | Outline: sound and video play in place | Deferred kinds routed to their own renderers |
...
| C8 | `.mmd` | Deferred | diagram renderer, inline (step 6) | BDD Outline: sound and video play in place | Fenced diagrams already work by another route |
