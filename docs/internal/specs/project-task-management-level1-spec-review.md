...
> **Superseded 2026-08-21:** the core_team cap was removed entirely (no size limit); see project-task-management-level1-spec.md (FR-005). The deduplication requirement still holds; only the ">20 entries → HTTP 400" cap is gone.
