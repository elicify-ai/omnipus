...
- **FR-001 … FR-075** as enumerated in §9. All MUST. **Counts: 100 rows in the §9 matrix, 10 of them withdrawn tombstones (FR-011, FR-012, FR-014a, FR-038, FR-038a, FR-039, FR-046, FR-049, FR-055, FR-056), so 90 live FRs** — re-counted mechanically against the matrix, not carried forward. Movement in **this** revision (the D1.9b pass) is stated first, then the D1.5c/D1.5d pass's, then D1.5b's, then the D1.5a subtraction pass, then revision 4's, each amending the one below it:
