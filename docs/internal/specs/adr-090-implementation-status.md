...
| Provider image request matrix and candidate checks | Visual provider requirements and BDD-10/11/12 | Provider and transport commits ready; worker scoped tests pass; parent integration pending |
