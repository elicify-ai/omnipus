...
| 39 | `TestCoreTeam_MaxLengthEnforced` | Unit | core_team > 20 entries → 400 | 21 entries rejected; 20 accepted |
...
| 3 | `{"core_team":[21 distinct entries]}` | over limit | 400 | Update core_team | > 20 entries rejected |
| 4 | `{"core_team":[20 distinct entries]}` | at limit | 201/200 | Update core_team | 20 is valid |
