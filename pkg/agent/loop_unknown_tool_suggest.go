...
// loop_unknown_tool_suggest.go — the "did you mean …" ranking for an unknown
// tool name (C4 fix + UAT 2026-09-13 D-96). Lifted out of loop.go in the
// 2026-09-15 merge of integrate/library-improvements-v0.1.1 onto
// release/v0.1.1: loop.go itself comes from release (#683), and this ranking
// is tool-dispatch UX, not judge/goal logic, so it lives in its own file and
// loop.go changes only at the one call site.
