...
//
// MAJOR-2 (code review 2026-08-04): this function previously returned half of
// a hardcoded 4 GB fallback constant (the non-Linux readMemTotalBytes, deleted
// once this stopped being its only caller — it is Linux-only now),
