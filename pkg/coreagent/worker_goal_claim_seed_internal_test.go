...
// not through SeedConfig, so a regression in the seed value itself is caught
// even if SeedConfig ever post-processes the stored value. The seed must grant
// goal_claim via the ceiling on its own (founder decision 2026-09-15,
// issue #710).
