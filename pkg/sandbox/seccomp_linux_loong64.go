...
// seccomp_data.arch for a native loong64 (LoongArch64) syscall entry. Used
// by assembleBPFMode in seccomp_linux.go to reject syscalls arriving
// through a different ABI entry point than the one blockedNrs was built
// from.
//
...
const nativeAuditArch = unix.AUDIT_ARCH_LOONGARCH64
