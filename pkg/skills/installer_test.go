...
func TestParseGitHubRef(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			repo:         "https://github.com/elicify-ai/omnipus/tree/dev/skills/test",
			wantOwner:    "elicify-ai",
		...
		},
		{
			...
			repo:         "https://github.com/elicify-ai/omnipus/blob/main/README.md",
			wantOwner:    "elicify-ai",
			wantRepoName: "omnipus",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/elicify-ai/omnipus",
			wantOwner:    "elicify-ai",
			wantRepoName: "omnipus",
			wantRef:      "main",
			wantSubPath:  "",
