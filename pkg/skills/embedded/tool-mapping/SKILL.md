...
3. Confirm the combined proposal once, apply it, and read back effective runtime policy.
## Expected output
Verified override changes with inherited entries left absent.
## Stop and handoff
Never manufacture a deny-all backfill. A denied management operation remains incomplete.
