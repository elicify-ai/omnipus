...
2. Use switch_agent to Jim for projects, Ava for teammate/skill configuration, or Admin for setup.
...
## Stop and handoff
If switch_agent is denied or unavailable, report the limitation and preserve the handoff summary.
