...
3. Ava: cover purpose/type, editable fields, effective tools, installed connectors, skills, workspace team, delegation edges, and a real model from list_models; output one combined proposal.
...
## Stop and handoff
Skip answered questions. Stop on a material ambiguity; use AskUserQuestion only in an owner session or message_parent when delegated.
