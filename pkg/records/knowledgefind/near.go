...
func buildRelationGraph(ctx context.Context, d Deps) (*relationGraph, *RefusalError) {
	if d.Store == nil {
		return nil, refuse(problem(generated.RecordProblemCodeIndexUnavailable,
	...
	if err != nil {
		if errors.Is(err, errHopTraversalBoundExceeded) {
			return nil, refuse(problem(generated.RecordProblemCodeHopTraversalBoundExceeded,
...
func nearReachable(ctx context.Context, d Deps, q *query) (reached map[string]bool, anchorPath string, _ *RefusalError) {
	...
	if !ok {
		...
		if d.ResolveNear != nil && anchorPath == "" {
			p := problem(generated.RecordProblemCodeNearUnresolved,
