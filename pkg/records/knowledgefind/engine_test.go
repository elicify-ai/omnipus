...
func TestExplain_NamesEveryPropertyAndItsIndex(t *testing.T) {
	...
	for _, step := range *resp.Plan {
		if step.Stage == generated.VaultFindPlanStepStageCompare {
		...
		if step.Stage == generated.VaultFindPlanStepStageNarrow {
...
func TestBound_B1QuotesItsCountAndNamesScope(t *testing.T) {
	...
	if p.Code != generated.RecordProblemCodeEvaluationBoundExceeded {
...
func TestBound_B2QuotesNoTotalItNeverComputed(t *testing.T) {
	...
	if p.Code != generated.RecordProblemCodeCandidateCapExceeded {
