...
func TestBoundRefusal_DoesNotAdviseTheCallThatLoops(t *testing.T) {
	for _, code := range []generated.RecordProblemCode{
		generated.RecordProblemCodeCandidateCapExceeded,
		generated.RecordProblemCodeEvaluationBoundExceeded,
	} {
...
func TestResponseBudget_IsNotBypassableByTheProblemList(t *testing.T) {
	...
	for i := 0; i < 200; i++ {
		resp.Problems = append(resp.Problems, problem(generated.RecordProblemCodeStaleRecord,
