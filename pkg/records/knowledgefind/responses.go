...
func refusalActions(r *RefusalError) []generated.VaultFindAction {
	...
	case generated.RecordProblemCodeUnknownProperty, generated.RecordProblemCodeUnknownEnumValue, generated.RecordProblemCodeUnknownRecordType:
		out = append(out, generated.VaultFindAction{Label: "describe", Call: "knowledge_describe"})
	case generated.RecordProblemCodeEvaluationBoundExceeded, generated.RecordProblemCodeCandidateCapExceeded:
		...
		out = append(out, generated.VaultFindAction{Label: "describe", Call: "knowledge_describe"})
	case generated.RecordProblemCodeStaleCursor:
...
func explainResponse(q *query, echo string) generated.VaultFindResponse {
	...
	plan = append(plan, generated.VaultFindPlanStep{
		Stage:  generated.VaultFindPlanStepStageScope,
	...
	plan = append(plan, generated.VaultFindPlanStep{
		Stage:  generated.VaultFindPlanStepStageNarrow,
	...
	if q.words != "" {
		plan = append(plan, generated.VaultFindPlanStep{
			Stage:  generated.VaultFindPlanStepStageRetrieve,
	...
	if q.filter != nil {
		for _, leaf := range q.filter.leaves() {
			p := leaf.Property
			plan = append(plan, generated.VaultFindPlanStep{
				Stage:    generated.VaultFindPlanStepStageCompare,
				Property: str(p.Name),
	...
	for _, j := range q.join {
		plan = append(plan, generated.VaultFindPlanStep{
			Stage:    generated.VaultFindPlanStepStageJoin,
			Property: str(j),
			Source:   sourcePtr(generated.VaultFindPlanStepSourcePropertiesIndex),
	...
	for _, g := range q.groupBy {
		...
		plan = append(plan, generated.VaultFindPlanStep{
			Stage:    generated.VaultFindPlanStepStageGroup,
	...
	for _, s := range q.sort {
		...
		plan = append(plan, generated.VaultFindPlanStep{
			Stage:    generated.VaultFindPlanStepStageSort,
	...
	for _, a := range q.aggregates {
		step := generated.VaultFindPlanStep{
			Stage:  generated.VaultFindPlanStepStageAggregate,
			Source: sourcePtr(generated.VaultFindPlanStepSourceGoComparator),
	...
	plan = append(plan, generated.VaultFindPlanStep{
		Stage:  generated.VaultFindPlanStepStageRender,
	...
	return generated.VaultFindResponse{
		...
		Plan:      &plan,
		Next: []generated.VaultFindAction{
			{Label: "run", Call: "knowledge_find " + echo + " (drop explain to evaluate)"},
		},
	}
}
...
func zeroHitResponse(ctx context.Context, d Deps, q *query, echo string) generated.VaultFindResponse {
	...
	if d.Text != nil && q.words != "" {
		...
		if err != nil {
			...
			// disappearing.
			resp.Problems = append(resp.Problems, problem(generated.RecordProblemCodeIndexUnavailable,
	...
	if len(terms) > 0 {
		...
		resp.Next = append(resp.Next, generated.VaultFindAction{
			Label: "retry", Call: `knowledge_find words="` + terms[0].Term + `"`,
		})
	}
	if q.schema != nil {
		resp.Next = append(resp.Next, generated.VaultFindAction{
...
func findTasks(ctx context.Context, d Deps, q *query, echo string) (generated.VaultFindResponse, error) {
	...
	if bad := taskUnsupportedArgs(q); len(bad) > 0 {
		ref := refuse(problem(generated.RecordProblemCodeUnsupportedParameter,
	...
	for _, h := range page {
		...
		if fresh == propindex.FreshnessAgree {
			...
			t := true
			row.Stale = &t
			p := problem(generated.RecordProblemCodeStaleRecord, h.Path+": "+fresh.Reason(),
