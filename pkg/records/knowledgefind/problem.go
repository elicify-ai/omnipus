...
// IsRefusal reports whether err is a knowledge_find refusal.
...
func classifyQueryError(qe *records.QueryError, f records.Filter) generated.RecordProblemCode {
	...
	case records.OpIn:
		if len(f.Literals) == 0 {
			return generated.RecordProblemCodeEmptyInList
		}
	case records.OpLike:
		if f.Literal == "" || f.Literal == "%" {
			return generated.RecordProblemCodeEmptyLikePattern
		}
	}
	...
	case strings.Contains(r, "is not a supported operator"):
		return generated.RecordProblemCodeUnsupportedOperator
	case strings.Contains(r, "ordering comparisons are not defined"),
		strings.Contains(r, "holds many values"):
		return generated.RecordProblemCodeOrderingOnManyProperty
	case strings.Contains(r, "has no property"):
		return generated.RecordProblemCodeUnknownProperty
	...
	case strings.Contains(r, "is not a valid"):
		...
		if len(qe.ValidNames) > 0 {
			return generated.RecordProblemCodeUnknownEnumValue
		}
		return generated.RecordProblemCodeLiteralTypeMismatch
	}
	return generated.RecordProblemCodeTypeMismatch
}
...
func findingProblem(recordID, path string, f records.Finding) generated.RecordProblem {
	...
	p := generated.RecordProblem{
		Code:    generated.RecordProblemCodeTypeMismatch,
		Reason:  reason,
		Records: []string{id},
		Paths:   &[]string{path},
	}
