// Omnipus — ADR-068 D15.3 / spec 4.1.2 and 4.2: knowledge_find, the one retrieval path.
// License: MIT
// Copyright (c) 2026 Omnipus contributors

// Package knowledgefind implements `knowledge_find` — plain words, typed filters, saved
