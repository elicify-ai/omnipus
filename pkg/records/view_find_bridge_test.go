...
func TestViewFindLoader_FilterTreeIsCopiedNotAliased(t *testing.T) {
	tree := &generated.VaultFilterNode{All: &[]generated.VaultFilterNode{
		{Property: ptr("status"), Op: ptr(generated.VaultFilterNodeOpEqual), Value: ptr("open")},
		{Any: &[]generated.VaultFilterNode{
			{Property: ptr("amount"), Op: ptr(generated.VaultFilterNodeOpGreaterThanEqual), Value: ptr("10000")},
			{Not: &generated.VaultFilterNode{Property: ptr("owner"), Op: ptr(generated.VaultFilterNodeOpISNULL)}},
		}},
	}}
