...
// way propindex's own BoundError never reaches vault_find's response either.
var errHopTraversalBoundExceeded = errors.New("vaultfind: relation graph traversal exceeded its edge bound")
