...
// index, vault_find refuses BY NAME and never returns an empty success.
// License: MIT
...
// The four entry points ADR-068 D15 names for vault_find. Each costs one test,
...
//
// What this catches that no static check can: a vault_find that queries bleve,
