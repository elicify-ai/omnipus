...
// TestNewRootCommand_KeptCommandsPresent verifies that the minimized command
...
func TestNewRootCommand_KeptCommandsPresent(t *testing.T) {
	cmd := NewRootCommand()
...
// TestNewRootCommand_RemovedVerbsAreUnknown verifies that each removed verb
...
func TestNewRootCommand_RemovedVerbsAreUnknown(t *testing.T) {
	cmd := NewRootCommand()
	require.NotNil(t, cmd)
...
// TestNewRootCommand_GatewayAliasResolvesToStart verifies that the `gateway`
// and `g` aliases are preserved on the `start` subcommand (US-11/AC-3).
func TestNewRootCommand_GatewayAliasResolvesToStart(t *testing.T) {
	cmd := NewRootCommand()
	require.NotNil(t, cmd)
...
// TestNewRootCommand_RootHasRunE verifies that the root command has a RunE
// handler (the positional execute path) and declares the expected flags.
func TestNewRootCommand_RootHasRunE(t *testing.T) {
	cmd := NewRootCommand()
	require.NotNil(t, cmd)
...
// TestNewRootCommand_HelpTextIncludesExecuteForm verifies that the root
// Long / Example contain the execute form and do not contain removed verbs
// (FR-009/US-7).
func TestNewRootCommand_HelpTextIncludesExecuteForm(t *testing.T) {
	cmd := NewRootCommand()
	require.NotNil(t, cmd)
...
// TestNewRootCommand_StopSubcommandPresent verifies that the stop subcommand
// is registered in the command tree with the correct name.
func TestNewRootCommand_StopSubcommandPresent(t *testing.T) {
	cmd := NewRootCommand()
	require.NotNil(t, cmd)
