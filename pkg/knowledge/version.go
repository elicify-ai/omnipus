...
const ConflictCode = string(generated.KnowledgeConflictErrorCodeKnowledgeVersionConflict)
...
func (e *ConflictError) Wire() generated.KnowledgeConflictError {
	body := generated.KnowledgeConflictError{
		Error: e.Error(),
		Code:  generated.KnowledgeConflictErrorCodeKnowledgeVersionConflict,
		Path:  e.Path,
	}
	if e.Expected != "" {
