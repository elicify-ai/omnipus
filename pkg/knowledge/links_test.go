...
var allowedToolsSelectors = []string{
	...
	// (pkg/tools/result.go). knowledge_describe needs it because its response is
...
func TestKnowledge_NoLanguageModelInTheGraphPath(t *testing.T) {
	...
	// call belongs to; knowledge_edit.go (ADR-068 D15.3) is the FR-070c
	...
	//
	// knowledge_edit.go specifically: EditTool.Execute parses args, calls
