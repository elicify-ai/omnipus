// Omnipus — tests for vault_describe (spec §4.1.1, AC-D1..D6, FR-072, FR-079).
// License: MIT
...
func TestDescribe_RenderedArtifact(t *testing.T) {
	...
	t.Logf("\n----- BEGIN vault_describe RESPONSE -----\n%s----- END vault_describe RESPONSE -----", text)
...
func TestDescribeTool_DescriptionFitsTheBudgetAndNamesTheWidestOperation(t *testing.T) {
	...
	if (&DescribeTool{}).Name() != "vault_describe" {
