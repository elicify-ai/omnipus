...
func TestAttach_StartLogged(t *testing.T) {
	...
	handler.handleAttachSession(context.Background(), "chat-log-test", meta.ID, nil, nil, nil, wc)
...
func TestAttach_EndLogged(t *testing.T) {
	...
	handler.handleAttachSession(context.Background(), "chat-end-log-test", meta.ID, nil, nil, nil, wc)
