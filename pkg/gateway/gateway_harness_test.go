...
// requires RegisterGatewayRunner to be called first — which happens in this
// package's TestMain. Placing them here avoids an import cycle while still
// exercising the harness against the real gateway.
//
