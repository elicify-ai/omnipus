...
func TestKnowledgeInfo_UndecidableFoldersFailLoudly_E9(t *testing.T) {
	...
	t.Run("missing folder", func(t *testing.T) {
		...
		assert.Equal(t, gen.KnowledgeBaseInfoDetectionErrorCodeRootMissing, info.DetectionError.Code)
	...
	t.Run("path is a file", func(t *testing.T) {
		...
		assert.Equal(t, gen.KnowledgeBaseInfoDetectionErrorCodeNotADirectory, info.DetectionError.Code)
	})
