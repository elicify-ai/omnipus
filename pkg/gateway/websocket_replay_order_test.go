...
func TestReplay_DivertFlagClearedAfterDrain_FlagState(t *testing.T) {
	...
	handler.handleAttachSession(context.Background(), "chat-flag-test", meta.ID, nil, nil, nil, wc)
...
func TestReplay_DivertDrainedBeforeFlag_OrderWithRealConcurrency(t *testing.T) {
	...
	handler.handleAttachSession(context.Background(), "chat-concurrent-test", meta.ID, nil, nil, nil, wc)
...
func TestReplayOrdering_ConcurrentUpdateDuringDrain(t *testing.T) {
	...
	handler.handleAttachSession(context.Background(), "chat-concurrent-update", meta.ID, nil, nil, nil, wc)
...
func TestReplayDrain_SlowClientDeadline(t *testing.T) {
	...
	go func() {
		defer close(done)
		handler.handleAttachSession(context.Background(), "chat-slow-client", meta.ID, nil, nil, nil, wc)
	}()
