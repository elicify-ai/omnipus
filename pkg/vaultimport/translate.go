...
func nodeFromRawLeaf(rl RawLeaf, source string) *rawNode {
	...
	switch rl.Op {
	case "eq":
		leaf.Shape, leaf.Op = shapeCompare, generated.VaultFilterNodeOpEqual
	case "lt":
		leaf.Shape, leaf.Op = shapeCompare, generated.VaultFilterNodeOpLessThan
	case "lte":
		leaf.Shape, leaf.Op = shapeCompare, generated.VaultFilterNodeOpLessThanEqual
	case "gt":
		leaf.Shape, leaf.Op = shapeCompare, generated.VaultFilterNodeOpGreaterThan
	case "gte":
		leaf.Shape, leaf.Op = shapeCompare, generated.VaultFilterNodeOpGreaterThanEqual
	case "contains":
